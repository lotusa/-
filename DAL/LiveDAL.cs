...
FROM       Room INNER JOIN Live ON Room.R_Id = Live.R_Id";
        ...
        private static List<Live> GetList(DataTable table)
        {
            ...
            foreach (DataRow row in table.Rows)
            {
                ...
                LiveModel.L_Gender = Convert.ToByte(row["L_Gender"]) == 1 ? "男" : "女";
