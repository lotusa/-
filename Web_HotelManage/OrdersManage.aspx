<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrdersManage.aspx.cs" Inherits="RoomManage" %>
    ...
    <div>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td align="center"><asp:LinkButton ID="ibDel" runat="server"  Text="取消订单"
                                    CommandArgument='<%# Eval("O_Id") %>' 
               OnClientClick="return confirm('确定取消该订单吗?取消后不可以恢复！')" onclick="ibDel_ItemDeleting" />
                </td>
            </tr>
        </ItemTemplate>
